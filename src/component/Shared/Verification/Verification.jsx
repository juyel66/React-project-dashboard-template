...
//     const handleSubmit = () => {
//         alert(`Entered OTP: ${otp.join("")}`); // Revert to original alert behavior
//     };

//     const handleResendClick = () => {
//         setIsModalOpen(true); // Open modal when "click here.." is clicked
//     };
...
//                         <p className="text-[#012939] text-[20px] font-medium">
//                         Code has been sent again
//                         </p>
//                         <div className="flex justify-end space-x-4">
//                             <button
//                                 onClick={closeModal}
//                                 className="bg-gray-300 text-gray-800 px-4 py-2 rounded-[8px] font-semibold"
//                             >
//                                 Close
//                             </button>
//                             <button
//                                 onClick={closeModal}
//                                 className="bg-[#1B97D8] text-[#F6F8FA] px-4 py-2 rounded-[8px] font-semibold"
//                             >
//                                 OK
//                             </button>
//                         </div>
