                        ...
                        <div key={index} className="flex items-center justify-between bg-white p-4 rounded-md shadow-sm h-[81px]">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="flex space-x-4 ">
                                    ...
                                    <button className=" text-sm underline cursor-pointer" onClick={() => document.getElementById('my_modal_1').showModal()}>  View profile</button>
                                    <dialog id="my_modal_1" className="modal mx-auto my-auto w-[590px] p-6 rounded bg-[#F6F8FA]">
                                        ...
                                        <div className="modal-box flex items-center gap-10 space-y-3">
                                            ...
                                            <div>
                                                ...
                                                <p className='text-[#595B5B] text-[18px] mt-5'>Rating:4.7 <span className='text-[#0D95DD]'>( 8 Reviews )</span></p>
                                            </div>
