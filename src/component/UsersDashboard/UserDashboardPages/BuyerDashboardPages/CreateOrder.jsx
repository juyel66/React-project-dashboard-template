...
//   const [category, setCategory] = useState("");
//   // const [currency, setCurrency] = useState("USD");
//   const [location, setLocation] = useState({ lat: 40.712776, lng: -74.005974 }); // Default: New York

//   // const apiKey = process.env.REACT_APP_GOOGLE_MAPS_API_KEY; // Load API key from .env
...
//               className="w-full px-3 py-2 border border-[#5C91B1] bg-[#F8FCFF] rounded"
//               onChange={(e) => {
//                 // Optional: Add geocoding logic here to update location
//               }}
//             />
//           </div>
//         </div>
...
//                 className="p-1 px-2 w-full text-sm focus:outline-none"
//                 onChange={(e) => {
//                   // Add search logic here (e.g., Geocoding API)
//                 }}
//               />
//             </div>
//             <button className="bg-blue-100 text-blue-600 px-2 py-1 rounded text-xs">
