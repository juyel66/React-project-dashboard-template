...
import { MdOutlineCleanHands, MdOutlineHeadsetMic } from "react-icons/md";
          ...
          <div className="modal modal-open">
            ...
            {modalContent === "cancel" && (
              <div className="modal-box relative bg-[#EFF2F6] w-[470px] h-[370px] rounded p-6 text-[#154153]">
                ...
                <div className="py-8">
                  ...
                  <textarea className="border border-[#5C91B1] p-2 w-full rounded h-[111px] mt-4" placeholder="Enter here"></textarea>
                </div>
            ...
            {modalContent === "delivery" && (
              <div className="modal-box relative bg-[#EFF2F6] w-[470px] rounded p-6 text-[#154153]">
                ...
                <div className="text-center">
                  <button className="btn btn-active bg-[#0D95DD] p-4 rounded-2xl w-[120px] font-bold text-[17px] text-[#FFFFFF] cursor-pointer">Deliver</button>
                </div>
              </div>
            )}
              ...
              <div className="modal-box relative bg-[#EFF2F6] w-[470px] rounded p-6 text-[#154153]">
                ...
                <div className="py-10 space-y-3">
                  ...
                  <div className="">
                    ...
                    <textarea className="border border-[#5C91B1] p-2 w-full rounded h-[111px] mt-3" placeholder="Enter here"></textarea>
                  </div>
                </div>
  
                <div className="text-center">
                  <button className="btn btn-active bg-[#0D95DD] p-4 rounded-2xl w-[120px] font-bold text-[17px] text-[#FFFFFF] cursor-pointer">Submit</button>
                </div>
              </div>
            )}
